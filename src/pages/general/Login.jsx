...
const Login = () => {
    ...
    return (
        <Layout>
            <div className="h-screen border border-slate-700">
                {loading && <Loading />}
                <div className='w-[90%] mx-auto py-[3rem]'>
                    ...
                    <form onSubmit={submitForm} className='mt-[4rem]'>
                            ...
                            <div className='flex gap-[1rem] flex-col'>
                                <div className='flex gap-[0.5rem] flex-col relative'>
                                    <div className='flex gap-1'>
                                        ...
                                        <div className='text-[0.75rem] capitalize font-[550] text-white'>phone address</div>
                                    </div>
                        ...
                        <div className='text-[0.8rem] font-[550] text-[#61611a] text-right pt-[0.5rem] cursor-pointer capitalize'>forgot password?</div>
                        <div className='flex flex-col gap-[0.5rem] items-center mt-[3rem]'>
                            <button className='outline-none bg-[#61611a] py-[0.5rem] px-[8rem] h-fit w-fit rounded-md capitalize text-[0.9rem] text-[white] cursor-pointer font-[550]' type='submit' >login</button>
                            <div className='text-white text-[0.8rem] font-[550]'>Don't have an account?
                                <Link to='/signup' className='cursor-pointer text-[#61611a]' > Sign Up</Link>
                            </div>
                        </div>
                    </form>
                </div>
